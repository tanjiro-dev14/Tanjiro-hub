...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("Tanjiro HubshHit") or v.Name == ("SwordTanjiro Hubsh") or v.Name == ("Tanjiro HubshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "Tanjiro Hub Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Tanjiro Hub Hub"})

OrionLib:MakeNotification({
	Name = "Tanjiro Hub Hub",
...
W:AddLabel("[+] Tanjiro Hub Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Tanjiro Hub Hub(Noitification)",
